...
const getManagerInfo = () => {
    console.log(` Please enter all information for Intern addition. All questions are required to complete.`);
...
const getEngineerInfo = () => {
    console.log(` Please enter all information for Engineer addition. All questions are required to complete.`);
